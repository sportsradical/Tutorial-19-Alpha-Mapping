...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/square.txt", 
					"../Engine/data/stone01.tga", "../Engine/data/dirt01.tga", "../Engine/data/alpha01.tga");
	if(!result)
	{
...
bool GraphicsClass::Render()
{
	...
	m_AlphaMapShader->Render(m_D3D->GetDeviceContext(), m_Model->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
							 m_Model->GetTextureDifuse1(), m_Model->GetTextureDifuse2(), m_Model->GetTextureAlpha());
