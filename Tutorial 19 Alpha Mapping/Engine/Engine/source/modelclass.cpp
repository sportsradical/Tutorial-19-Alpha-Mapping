...
ID3D11ShaderResourceView** ModelClass::GetTextureDifuse1()
{
	return m_Texture->GetTexture();
}

ID3D11ShaderResourceView** ModelClass::GetTextureDifuse2()
{
	return m_Texture1->GetTexture();
}

ID3D11ShaderResourceView** ModelClass::GetTextureAlpha()
{
...
bool ModelClass::LoadTextures(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename1, char* filename2, char* filename3)
{
	...
	// Initialize the texture array object.
	result = m_Texture1->Initialize(device, deviceContext, filename1);
	if (!result)
	{
		return false;
	}
	...
	// Initialize the texture array object.
	result = m_Texture2->Initialize(device, deviceContext, filename1);
	if (!result)
	{
		return false;
	}
